        ...
        <div class="max-w-md mx-auto bg-gray-800 bg-opacity-50 p-8 rounded-lg text-center">
            {#if loading}
                <div class="flex flex-col items-center justify-center">
                    <svg class="animate-spin h-5 w-5 text-white mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {:else if error}
                ...
                <a href="/account" class="text-blue-400 hover:underline">Back to Account</a>
            {/if}
        </div>
    </div>
</main>